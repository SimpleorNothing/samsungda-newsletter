...
- **뉴스별 3필드**(불릿 3개, AI 생성):
  ...
  - `opportunity`: 당사 강점·포지션 관점 유리 지점(80자). **'기회:' 라벨 금지, 서술식**. 시작말('당사도'·'우리 DA엔'·'당사 관점에선')·맺음말 매 항목 변주. 근거 약하면 "제한적" 서술.
  - `threat`: 경쟁·시장·정책 압박(80자). **'위협:' 라벨 금지**. 대비 접속('다만'·'한편'·'경쟁 측면에선'·'그러나') 변주.
