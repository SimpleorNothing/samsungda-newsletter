...
1. **기본 편성은 경쟁사 중심 3:1:1.** 5건 기준 경쟁사 3건(약 60%) · 유관산업/기술 1건(약 20%) · 정책/규제/거시 1건(약 20%)을 우선한다. 해당 영역의 후보가 부족하면 다른 영역으로 자동 충당한다.
...
## 변경 이력
- **2026-09-10 22:53 (KST)** — fix(index): 조사 앞 공백 정리가 단어 띄어쓰기까지 지우던 문제 수정 (#148) (`1ade303`)
- **2026-09-10 22:43 (KST)** — fix(cron): 헬스체크를 09:00 → 07:15 KST로 이동 (#147) (`6ea9ca5`)
- **2026-09-07 21:40 (KST)** — fix(insights): B안 주간 큐레이션 실패 안전망 강화 (`816d5fe`)
- **2026-09-07 19:48 (KST)** — feat(index): /insights-debug 조회 전용 라우트 추가 (#145) (`56b59a6`)
- **2026-09-07 19:35 (KST)** — fix(index): 리서치 인사이트 표시를 B안 요일 태그 기반으로 전환 (#144) (`e4e0e7b`)
- **2026-09-04 11:29 (KST)** — fix(insights): 국가데이터처 최신 원문 검증 반영 (`f164dcb`)
- **2026-09-04 11:09 (KST)** — fix: Cloudflare 주간 cron 요일 형식 수정 (#142) (`0b37d3b`)
- **2026-09-04 11:00 (KST)** — feat(insights): B안 주간 15개·요일별 3개 편성 및 원문링크 강화 (#141) (`048802f`)
- **2026-09-04 10:27 (KST)** — fix(insights): 리서치 인사이트 중복 발행 방지 이력 추가 (#140) (`8b1d264`)
- **2026-09-04 10:23 (KST)** — fix(insights): bok.or.kr 카드는 상세글(nttId) 링크만 허용, list.do는 검증 실패 처리 (#139) (`73a36da`)
- **2026-09-02 13:16 (KST)** — [nl] 리서치 인사이트 원문 링크 실시간 검증 — 연결 안 되는 링크는 대체 URL로 강등하지 않고 카드 자체를 제외 (#138) (`8da492c`)
- **2026-08-29 11:57 (KST)** — fix: 헬스체크 09:00 KST로 앞당김 (#137) (`7c9eac0`)
- **2026-08-29 11:41 (KST)** — fix: 헬스체크 자동복구(recover) 콜백 연결 (#136) (`b82eaf4`)
- **2026-08-16 07:21 (KST)** — fix: 뉴스레터 자동 동기화 push 경합 방지 (`6e42f1c`)
- **2026-08-16 07:19 (KST)** — [nl] 시장 동향 기회·위협을 삼성전자 관점으로 고정 (`0334447`)
- **2026-08-14 20:12 (KST)** — fix(insights): 한국은행 상세글 링크를 게시판 목록 URL로 강등 (`c1fb1a3`)
- **2026-08-14 12:40 (KST)** — v1.4: 리서치 인사이트 카드 노출 기간 3개월 상한 규칙(§2-7) 신설 — `filterRecentInsights()` 이중 적용(R2 피드·SEED 공통)
- **2026-08-14 12:34 (KST)** — 장애 복구: `src/index.js`가 웹 에디터 붙여넣기 truncation으로 117,988B에서 잘렸던 것을 복원(누락 102행 재입력). ⚠ 126KB 파일은 모바일 전체 붙여넣기 금지 — 변경 구간만 조각으로 반영할 것
- **2026-08-14 12:34 (KST)** — index.js 업데이트 (`00dacb7`)
